...
type ComponentDefinition struct {
	...
	Model struct {
		...
		Status *ComponentDefinitionModelStatus `json:"status" yaml:"status"`
		...
		Registrant struct {
			...
			Status ComponentDefinitionModelRegistrantStatus `db:"status" json:"status" yaml:"status"`
		...
		Metadata *ComponentDefinition_Model_Metadata `gorm:"type:bytes;serializer:json" json:"metadata,omitempty"`
	...
	} `gorm:"foreignKey:ModelId;references:Id" json:"model"`

	// Styles Visualization styles for a component
	Styles *ComponentDefinition_Styles `json:"styles" yaml:"styles"`
	...
	Capabilities *[]struct {
		...
		EntityState []ComponentDefinitionCapabilitiesEntityState `json:"entityState"`

		// Status Status of the capability
		Status ComponentDefinitionCapabilitiesStatus `json:"status" yaml:"status"`
	...
	} `gorm:"type:bytes;serializer:json" json:"component"`
}
...
// ComponentDefinitionModelMetadataCapabilitiesEntityState A string starting with an alphanumeric character. Spaces and hyphens allowed.
...
type ComponentDefinition_Model_Metadata struct {
	...
	Capabilities *[]struct {
		...
		// EntityState State of the entity in which the capability is applicable.
		EntityState []ComponentDefinitionModelMetadataCapabilitiesEntityState `json:"entityState"`

		// Status Status of the capability
		Status ComponentDefinitionModelMetadataCapabilitiesStatus `json:"status" yaml:"status"`
...
// ComponentDefinitionCapabilitiesEntityState A string starting with an alphanumeric character. Spaces and hyphens allowed.
...
// Getter for additional properties for ComponentDefinition_Model_Metadata. Returns the specified
// element and whether it was found
func (a ComponentDefinition_Model_Metadata) Get(fieldName string) (value interface{}, found bool) {
...
// Setter for additional properties for ComponentDefinition_Model_Metadata
func (a *ComponentDefinition_Model_Metadata) Set(fieldName string, value interface{}) {
	if a.AdditionalProperties == nil {
...
// Override default JSON handling for ComponentDefinition_Model_Metadata to handle AdditionalProperties
func (a *ComponentDefinition_Model_Metadata) UnmarshalJSON(b []byte) error {
...
// Override default JSON handling for ComponentDefinition_Model_Metadata to handle AdditionalProperties
func (a ComponentDefinition_Model_Metadata) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
